...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        if self.flag_8sensors == True:
            
            filter_front_left = np.logical_and((y_points > x_points - 0.1414), (y_points < x_points + 0.1414))
            filter_front_left = np.logical_and(filter_front_left, x_points > 0, y_points > 0)
            ...
            # front right
            filter_front_right = np.logical_and((y_points > -x_points - 0.1414), (y_points < -x_points + 0.1414))
            filter_front_right = np.logical_and(filter_front_right, x_points > 0, y_points < 0)
            ...
            # rear left
            filter_rear_left = np.logical_and((y_points > -x_points - 0.1414), (y_points < -x_points + 0.1414))
            filter_rear_left = np.logical_and(filter_rear_left, x_points < 0, y_points > 0)
            ...
            # rear right
            filter_rear_right = np.logical_and((y_points > x_points - 0.1414), (y_points < x_points + 0.1414))
            filter_rear_right = np.logical_and(filter_rear_right, x_points < 0, y_points < 0)
